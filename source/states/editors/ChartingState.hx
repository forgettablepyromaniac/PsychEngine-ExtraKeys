...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Add Camera Zoom', "Used on MILF on that one \"hard\" part\nValue 1: Which camera to zoom (Default: camGame)\nValue 2: Amount to Zoom (Default 0.03)\nLeave the values blank if you want to use Default."],
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var stepperMania:FlxUINumericStepper = new FlxUINumericStepper(110, stepperBPM.y + 35, 1, 3, 0, 8);
